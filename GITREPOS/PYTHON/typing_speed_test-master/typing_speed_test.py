...
class MainWindow:
    ...
    def __init__(self, root):
        self.text = ["The greatest glory in living lies not in never falling, but in rising every time we fall.",
                     ...
                     "Rhizomes are modified stems that grow horizontally underground.",
                     "The only way to improve your typing is to type.",
                     "The only way to improve your typing is to type."]
        self.speed = 0
        self.accuracy = 0
        self.time_start = 0
        ...
        self.label_text = Label(
            root, text="A Very Warm Welcome To Typing SpeedChecker 😊", wraplength=500)
